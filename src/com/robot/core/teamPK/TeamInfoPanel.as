package com.robot.core.teamPK
{
   ...
   public class TeamInfoPanel
   {
      ...
      public function setHomeScore(n:uint) : void
      {
         this._homeScore_txt.text = String(n);
      }
      
      public function setAwayScore(n:uint) : void
      {
         this._awayScore_txt.text = String(n);
      }
      
      public function setTime(n:uint) : void
      {
         this._time_txt.text = String(n) + "分钟";
      }
