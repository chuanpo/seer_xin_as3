package com.robot.app.exchangeCloth
{
   ...
   public class ExchangeClothPanel extends Sprite
   {
      ...
      public function show(a:Array) : void
      {
         this.info_a = a;
         this.currentObj = a[0];
         this.currentIndex = 0;
      ...
      {
         this.uiLoader = new MCLoader(url,LevelManager.appLevel,1,"正在打开物资转换仪");
      ...
      private function configCloseBtn(b1:Boolean) : void
      {
         if(b1)
         {
      ...
      private function configExchangeBtn(b1:Boolean) : void
      {
         if(b1 == true)
         {
      ...
      private function onExchangeBtnClickHandler(event:MouseEvent) : void
      {
      ...
      private function onLeftMcClickHandler(event:MouseEvent) : void
      {
      ...
      private function onRightMcClickHandler(event:MouseEvent) : void
      {
