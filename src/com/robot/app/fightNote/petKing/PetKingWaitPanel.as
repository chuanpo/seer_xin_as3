package com.robot.app.fightNote.petKing
{
   ...
   public class PetKingWaitPanel
   {
      ...
      private static function closeWait(event:RobotEvent) : void
      {
      ...
      public static function showPetWar() : void
      {
         if(!_petWarPanel)
         {
            ...
            _petWarPanel["closeBtn"].addEventListener(MouseEvent.CLICK,function(e:MouseEvent):void
            {
      ...
      private static function onStartHandler(e:MouseEvent) : void
      {
      ...
      private static function closeSelect(event:MouseEvent) : void
      {
      ...
      public static function closeWaitPanel(event:MouseEvent) : void
      {
         MapManager.removeEventListener(MapEvent.MAP_SWITCH_OPEN,onMapSwitch);
         DisplayUtil.removeForParent(waitPanel,false);
      ...
      private static function selectModeHandler(event:MouseEvent) : void
      {
         var type:uint = 0;
         ...
         SocketConnection.send(CommandID.PET_KING_JOIN,type);
         closeSelect(null);
         showWait();
      }
