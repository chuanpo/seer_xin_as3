package com.robot.app.freshFightLevel
{
   ...
   public class FightChoicePanel
   {
      ...
      {
         this.uiLoader = new MCLoader(url,LevelManager.appLevel,1,"正在进入试炼之塔");
      ...
      private function onLoadUISuccessHandler(event:MCLoadEvent) : void
      {
         ...
         trace("MainManager.actorInfo.curFreshStage==/==" + MainManager.actorInfo.curFreshStage);
         trace("MainManager.actorInfo.maxFreshStage==/==" + MainManager.actorInfo.maxFreshStage);
