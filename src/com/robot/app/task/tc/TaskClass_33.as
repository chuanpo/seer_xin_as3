package com.robot.app.task.tc
{
   ...
   {
      public function TaskClass_33(info:NoviceFinishInfo)
      {
         super();
         TasksManager.setTaskStatus(33,TasksManager.COMPLETE);
         TaskController_33.delIcon();
         var str:String = "宇宙海盗被我们赶走了，但是赛尔们不要掉以轻心，" + "他们还像毒刺一样深深扎在美丽的宇宙当中，现在先让我来奖励完成任务的小英雄吧！";
         NpcTipDialog.show(str,this.getReward,NpcTipDialog.INSTRUCTOR,0,this.getReward);
      }
