package com.robot.app.task.tc
{
   ...
   public class TaskClass_15
   {
      ...
      public function TaskClass_15(i:NoviceFinishInfo)
      {
         super();
      ...
      private function luoqi() : void
      {
         ...
         {
            var str:String = "可怜的奇洛被宇宙海盗艾里逊遗弃了，赛尔<font color=\'#ff0000\'>" + MainManager.actorInfo.nick + "</font>，你来领养它吧，要好好呵护它哦！";
            NpcTipDialog.show(str,getQiluo,NpcTipDialog.QILUO,0,getQiluo);
         });
      }
