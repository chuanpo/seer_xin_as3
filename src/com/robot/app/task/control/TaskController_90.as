package com.robot.app.task.control
{
   ...
   public class TaskController_90
   {
      ...
      public static function openPetBook(n:uint = 0) : void
      {
         _isEnd = n;
      ...
      private static function clickdownHandler(e:MouseEvent) : void
      {
         clearInterval(_showInlTime);
         MainManager.getStage().removeEventListener(MouseEvent.CLICK,clickdownHandler);
         _pipi_pic.x = 2000;
      ...
      public static function initFun(f1:Function, m:MovieClip, m1:MovieClip) : void
      {
         _pipi_mc = m;
         delAdd = f1;
         _pipi_pic = m1;
      ...
      private static function showTalk() : void
      {
         ...
         {
            TasksManager.accept(TASK_ID,function(b:Boolean):void
            {
               if(b)
               {
                  showPanel();
