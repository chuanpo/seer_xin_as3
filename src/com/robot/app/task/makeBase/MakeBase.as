   ...
   public class MakeBase
   {
      ...
      private static function getStorageList(e:*) : void
      {
         ...
         for(i = 0; i < array.length; i++)
         {
            ...
            if(info.id == 500502)
            {
               TasksManager.getProStatus(TASK_ID,0,function(b:Boolean):void
               {
                  if(!b)
                  {
                     trace("未完成");
            ...
            {
               TasksManager.getProStatus(TASK_ID,2,function(b:Boolean):void
               {
                  if(!b)
                  {
                     trace("未完成");
      ...
      private static function getSomeThing(e:CommandID) : void
      {
         getUsedlist();
      }
