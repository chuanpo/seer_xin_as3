package com.robot.app.task.SeerInstructor
{
   ...
   public class SeerInstructorMain
   {
      ...
      public static function talkToInstructor(bSign:Boolean = false) : void
      {
         var instructor:String = NpcTipDialog.INSTRUCTOR;
      ...
      private static function acceptTask(e:Event) : void
      {
      ...
      private static function onComplete(event:MCLoadEvent) : void
      {
         ...
         TaskUIManage.loadHash.add(201,event.getLoader());
         InstructorIcon.show();
      }
   }
}
