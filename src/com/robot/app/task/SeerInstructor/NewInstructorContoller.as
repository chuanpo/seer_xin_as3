package com.robot.app.task.SeerInstructor
{
   ...
   public class NewInstructorContoller
   {
      ...
      private static function clickIcon(event:MouseEvent) : void
      {
         if(!panel)
         {
      ...
      public static function fight() : void
      {
         ...
         TasksManager.getProStatus(TASK_ID,5,function(b:Boolean):void
         {
            if(b)
            {
      ...
      public static function chekWaste() : void
      {
         ...
         if(TasksManager.getTaskStatus(TASK_ID) == TasksManager.ALR_ACCEPT)
         {
            TasksManager.getProStatus(TASK_ID,pro,function(b:Boolean):void
            {
               MapManager.currentMap.controlLevel["wasteMC"].visible = !b;
            });
         }
      }
      ...
      public static function setWaste() : void
      {
         ...
         TasksManager.complete(TASK_ID,pro,function(b:Boolean):void
         {
            if(b)
            {
