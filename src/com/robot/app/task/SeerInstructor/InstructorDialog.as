package com.robot.app.task.SeerInstructor
{
   ...
   public class InstructorDialog
   {
      ...
      private static function signHander(e:MouseEvent = null) : void
      {
         SeerInstructorMain.talkToInstructor(true);
      }
      
      private static function awardHander(e:MouseEvent = null) : void
      {
      ...
      private static function removeHander(e:MouseEvent = null) : void
      {
