package com.robot.app.mapProcess
{
   ...
   public class MapProcess_1 extends BaseMapProcess
   {
      ...
      override protected function init() : void
      {
         ...
         TasksManager.getProStatus(95,1,function(b:Boolean):void
         {
            if(b)
            {
      ...
      private function showBrocast(event:MouseEvent) : void
      {
         if(!this.panel)
         {
      ...
      private function onTimer(event:TimerEvent = null) : void
      {
         ...
         box.show(this.niusiTalkArr[this.timerIndex],0,-85,depthLevel["npc"]);
         ++this.timerIndex;
      }
      ...
      private function onUseInviter(event:SocketEvent) : void
      {
      ...
      private function onHitComponent(event:MapConfigEvent) : void
      {
      }
   }
}
