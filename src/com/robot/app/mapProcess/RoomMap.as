package com.robot.app.mapProcess
{
   ...
   public class RoomMap extends BaseMapProcess
   {
      ...
      private function doorplateShow(ui:Sprite) : void
      {
         if(Boolean(ui))
         {
            ...
            UserInfoManager.seeOnLine([MainManager.actorInfo.mapID],function(arr:Array):void
            {
               ...
               {
                  UserInfoManager.getInfo(arr[0].userID,function(info:UserInfo):void
                  {
                     ui["txt"].text = info.nick;
                  });
               }
      ...
      private function onDoorPlateInfo(e:MouseEvent) : void
      {
      ...
      private function onPetStorage(e:MouseEvent) : void
      {
