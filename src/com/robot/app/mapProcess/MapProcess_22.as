package com.robot.app.mapProcess
{
   ...
   import com.robot.app.task.YiyouProEnvironment.YiyouTaskTool;
   ...
   public class MapProcess_22 extends BaseMapProcess
   {
      ...
      private function chack() : void
      {
         ...
         {
            TasksManager.getProStatus(401,3,function(b:Boolean):void
            {
               if(!b)
               {
      ...
      private function onShowYiyouPanel(evt:MouseEvent) : void
      {
         if(TasksManager.getTaskStatus(404) == TasksManager.COMPLETE)
         {
            this._slopsAMC.removeEventListener(MouseEvent.CLICK,this.onShowYiyouPanel);
      ...
      private function onBeikeClick(e:MouseEvent) : void
      {
      ...
      public function onMusicHit() : void
      {
         ...
         TasksManager.complete(401,2,function(b:Boolean):void
         {
            if(b)
            {
