package com.robot.app.games.FerruleGame
{
   ...
   public class FerruleGamePanel
   {
      ...
      private function onLoad(event:MCLoadEvent) : void
      {
         ...
         this.curGame = event.getContent() as MovieClip;
      ...
      private function onBegainGameHandler(e:Event) : void
      {
      ...
      private function onStartClickHandler(e:MouseEvent) : void
      {
      ...
      private function onGamePanelClickHandler(e:MouseEvent) : void
      {
         if(!this.isThrow)
         {
            this.isThrow = true;
      ...
      private function onShowCircleHandler(e:Event) : void
      {
         ...
         trace(this._circleMC.x + "   " + this._circleMC.y);
      ...
      private function onCircleFrameHandler(e:Event) : void
      {
      ...
      private function onCircleMCEffectEndHandler(e:Event) : void
      {
         this.circleStop();
         this.miluReuse();
      }
      
      private function onbalakeMCEffectEndHandler(e:Event) : void
      {
         this.isHit = false;
      ...
      private function onSeerMCEffectEndHandler(e:Event) : void
      {
         this.miluReuse();
      }
      ...
      private function remove(b:Boolean = false) : void
      {
