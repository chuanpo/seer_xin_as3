package com.robot.app.sceneInteraction
{
   ...
   public class CloudFloorScene
   {
      ...
      {
         step = "1";
         var mc:MovieClip = MapManager.currentMap.controlLevel["hitKMC"] as MovieClip;
      ...
      private static function onEnterKettle(e:Event) : void
      {
      ...
      private static function onEnterK2(e:Event) : void
      {
