package com.robot.app.weekMonster
{
   ...
   public class WeekMonsterMain
   {
      ...
      private static function changeMap(e:MouseEvent) : void
      {
         closeHandler(null);
      ...
      private static function changeMap2(e:MouseEvent) : void
      {
         closeHandler(null);
         MapManager.changeMap(41);
      }
      
      private static function closeHandler(e:MouseEvent) : void
      {
