package com.robot.app.energy.utils
{
   ...
   public class EnergyController
   {
      ...
      public static function exploit(dn:uint = 0) : void
      {
      ...
      private static function onCountOK(e:Event) : void
      {
         ...
         var msg:String = "探测发现这块区域埋藏着能源" + tipStr + ",宝贵的能源" + tipStr + "可以给赛尔飞船提供能源。\n    你是否要" + type + "一些这样的" + tipStr + "呢？";
         NpcTipDialog.showAnswer(msg,exploitNow,null,NpcTipDialog.SHU_KE);
      }
