package com.robot.app.im.ui
{
   ...
   public class IMListItem extends Sprite
   {
      ...
      private function addTeacherIcon(isMyTeacher:Boolean = false) : void
      {
         this._teacherIcon.x = 114;
         this._teacherIcon.y = 1.5;
         this._mainUI.addChild(this._teacherIcon);
         this._isMyTeacher = isMyTeacher;
         if(isMyTeacher)
         {
      ...
      private function addStudentIcon(isMyStudent:Boolean = false) : void
      {
         this._studentIcon.x = 114;
         this._studentIcon.y = 1.5;
         this._mainUI.addChild(this._studentIcon);
         this._isMyStudent = isMyStudent;
         if(isMyStudent)
         {
      ...
      private function clickTeacherIcon(event:MouseEvent) : void
      {
      ...
      private function clickStudentIcon(event:MouseEvent) : void
      {
      ...
      protected function onTalk(e:MouseEvent) : void
      {
