package com.robot.app.toolBar.pkTool
{
   ...
   public class BasePKMouseIcon extends Sprite implements IPKMouseIcon
   {
      ...
      protected function clickWithMouseIcon(event:MouseEvent) : void
      {
         this.hide();
      ...
      {
         var p:Number = this.darkSize / this._coolingTime * this._timer.currentCount;
         this.dark.graphics.clear();
         this.dark.graphics.beginFill(0,0.5);
         this.dark.graphics.drawRoundRect(6,6 + p,this.darkSize,this.darkSize - p,5,5);
         this.dark.graphics.endFill();
      }
