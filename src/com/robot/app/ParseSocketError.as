package com.robot.app
{
   ...
   public class ParseSocketError
   {
      ...
      public static function addErrorListener(num:uint, listener:Function, useCapture:Boolean = false, priority:int = 0, useWeakReference:Boolean = false) : void
      {
         getInstance().addEventListener("ERROR_" + num,listener,useCapture,priority,useWeakReference);
      }
      
      public static function removeErrorListener(num:uint, listener:Function, useCapture:Boolean = false) : void
      {
         getInstance().removeEventListener("ERROR_" + num,listener,useCapture);
      }
