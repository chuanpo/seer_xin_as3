package com.robot.app.superParty
{
   ...
   public class SPChannelController
   {
      ...
      private static function onSwitchHandler(e:MapEvent) : void
      {
         mapID = e.mapModel.id;
      ...
      private static function ondesHandler(e:MapEvent) : void
      {
         MapManager.removeEventListener(MapEvent.MAP_DESTROY,ondesHandler);
         mapID = 0;
      }
      
      public static function initMC(m:MovieClip) : void
      {
         _m_3 = m;
      }
      
      public static function changeMap(id:uint) : void
      {
      ...
      private static function onSucHandler(e:MCLoadEvent) : void
      {
         _bounsMC = e.getContent() as MovieClip;
